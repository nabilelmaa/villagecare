      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl bg-clip-text text-transparent bg-gradient-to-r from-rose-900 to-rose-700">
            How VillageCare Works
          </h2>
          <p className="text-gray-600 md:text-xl/relaxed">
            Our platform makes it easy to connect elders with volunteers who can
          ...
          {[
            {
              ...
              title: "Sign Up",
              description:
                "Create an account as an elder seeking help or as a volunteer ready to assist.",
              step: 1,
            },
            {
              icon: Calendar,
              title: "Match",
              description:
                "Our system matches elders with volunteers based on needs, availability, and preferences.",
              step: 2,
            },
            {
              icon: MessageSquare,
              title: "Connect",
              description:
                "Communicate, schedule assistance, and build meaningful relationships.",
              step: 3,
            },
          ].map((item, index) => (
            <div
